...
const Navigation: React.FC = () => {
  return (
    <nav className='sticky w-full flex justify-center px-2 font-sans z-50
    md:text-[1.6em] md:-my-[1.6em]
    sm:text-[1.5em] sm:-my-[1.5em] sm:bottom-[2em]
    text-[1em] -my-[1em] bottom-[3em] tracking-tighter'>
      <div className='bg-[#010007] flex items-center text-white rounded-full has-[:hover]:bg-transparent transition-normal duration-200
        '>
        <button className='bg-[#010007] pl-6 pr-4 py-2 border border-gray-700 rounded-l-full transition-all
        ...
        <button className='bg-[#010007] px-4 py-2 border border-gray-700 transition-all
        ...
        <button className='bg-[#010007] pl-4 pr-6 py-2 border border-gray-700 rounded-r-full transition-all
