...
const Footer: React.FC = () => {
  return (
    <div className='bg-[#010007] flex justify-center items-center min-h-screen w-full py-24 h-fit text-white border-t border-neutral-800'>
      <div className='flex flex-col justify-center
        ...
        <h3 className='font-sans text-neutral-600 tracking-tighter text-5xl'>
          wish to connect?
        </h3>
