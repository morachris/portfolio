...
const ProjectInstance: React.FC<Props> = ({ title, description, specs, markdownContent, images }: Props) => {
  return (
    <div className='min-h-screen w-full overflow-hidden'>
      <a href='/' className='fixed bg-neutral-800 hover:border-none hover:bg-linear-90 hover:from-[#2441FF] hover:via-[#FF7DB7] hover:to-[#FFC471] rounded-md p-0.5 transition-all
      ...
      <div className='min-h-screen flex flex-col pb-24 overflow-hidden'>
        <div className='flex flex-col justify-center gap-8 items-center bg-[#010007] border-b border-neutral-800 w-full pt-32 pb-16'>
          ...
          <p className='font-sans-alt text-center tracking-tighter text-neutral-400
            xl:w-4xl
            lg:w-3xl lg:text-xl
            md:w-xl md:text-lg
            sm:w-lg sm:text-md
            w-[70vw] text-sm leading-[1.3em]'>
            {description}
          </p>
        ...
        <div className='py-16 mt-6 text-neutral-300 font-sans-alt m-auto
          ...
          w-[80vw] prose-h2:text-[2.7em] prose-h3:text-[2em]'
